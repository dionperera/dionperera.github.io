...
else if (window.location.hostname == "filter.meetcircle.com"){window.location.replace("https://b.dionperera.com/block");}
else if (window.location.hostname == "ip.dionperera.com"){window.location.replace("https://www.dionperera.com/ip");}
